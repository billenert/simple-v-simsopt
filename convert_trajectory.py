...
vmec = Vmec('wout.nc')
b = bx.Booz_xform()
b.read_boozmn('boozmn_LandremanPaul2021_QA_reactorScale_lowres_reference.nc')
...
'''Perform root solve to obtain BEAMS3D data in Boozer coordinates'''
...
if comm.rank == 0:
    ...
    # print(theta_b)
    # print(zeta_b)
    np.savetxt('./trajectories/path_theta_SIMPLE.txt',theta_b)
    np.savetxt('./trajectories/path_zeta_SIMPLE.txt',zeta_b)
    np.savetxt('./trajectories/path_s_SIMPLE.txt', s)
    np.savetxt('./trajectories/path_vpar_SIMPLE.txt', vpar0)
